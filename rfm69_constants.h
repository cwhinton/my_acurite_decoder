...
#define RegBitrateSet(x) { RFM69_Helper::write(RegBitrateMsb, (32000000/(x))/256); \
    RFM69_Helper::write(RegBitrateLsb, (32000000/(x))%256); }
...
#define RegFrfSet(x) { \
    ...
    RFM69_Helper::write(RegFrfMsb, (_l >> 16) & 0xFF); \
    RFM69_Helper::write(RegFrfMid, (_l >> 8) & 0xFF); \
    RFM69_Helper::write(RegFrfLsb, _l & 0xFF); }
